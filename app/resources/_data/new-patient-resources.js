const newPatientResourcesPage = {
	slug: [],
	pageHeading: "New Patient Paperwork",
	media: null,
	contentSections: [
		{
			text: [
		...
		{
			subheading: "Click the Link below for our Secure Online Registration:",
			links: [
				{
		...
		{
			subheading: "Information needed for online registration:",
		...
		{
			subheading: "Click the Link to Download Paperwork",
			links: [
				{
					label: "New Patient Paperwork",
					href: "/files/VSSNewPatient.pdf",
				},
				{
					label: "Medical Records Release Form",
					href: "/files/MedicalRecordsRelease.pdf",
				},
			],
		},
	],
...
export default newPatientResourcesPage
